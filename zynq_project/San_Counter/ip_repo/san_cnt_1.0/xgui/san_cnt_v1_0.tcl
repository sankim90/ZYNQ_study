...
proc update_PARAM_VALUE.COUNT_DEPTH { PARAM_VALUE.COUNT_DEPTH } {
	# Procedure called to update COUNT_DEPTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.COUNT_DEPTH { PARAM_VALUE.COUNT_DEPTH } {
	# Procedure called to validate COUNT_DEPTH
	return true
}
...
proc update_MODELPARAM_VALUE.COUNT_DEPTH { MODELPARAM_VALUE.COUNT_DEPTH PARAM_VALUE.COUNT_DEPTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.COUNT_DEPTH}] ${MODELPARAM_VALUE.COUNT_DEPTH}
}
