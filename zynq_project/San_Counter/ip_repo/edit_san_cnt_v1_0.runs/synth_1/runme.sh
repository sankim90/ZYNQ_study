...
HD_PWD='D:/ZYNQ_study/zynq_project/san_counter/ip_repo/edit_san_cnt_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log san_cnt_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source san_cnt_v1_0.tcl
