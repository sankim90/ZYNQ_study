...
HD_PWD='D:/ZYNQ_study/zynq_project/lab6_IRQ/lab6_IRQ.runs/system_san_cnt_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_san_cnt_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_san_cnt_0_0.tcl
